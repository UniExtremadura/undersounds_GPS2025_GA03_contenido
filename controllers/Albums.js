...
module.exports.albumsAlbumIdCommentsGET = function (req, res, next, albumId, page, limit) {
  Albums.albumsAlbumIdCommentsGET(albumId, page, limit)
    .then(r => utils.writeJson(res, r))
    .catch(e => utils.writeJson(res, { message: e.message }, e.status || 500));
};

module.exports.albumsAlbumIdCommentsPOST = function (req, res, next, body, albumId) {
...
module.exports.albumsAlbumIdStatsGET = function (req, res, next, albumId, range) {
  Albums.albumsAlbumIdStatsGET(albumId, range)
    .then(r => utils.writeJson(res, r))
    .catch(e => utils.writeJson(res, { message: e.message }, e.status || 500));
};

module.exports.albumsAlbumIdTracksPOST = function (req, res, next, body, albumId) {
  Albums.albumsAlbumIdTracksPOST(body, albumId)
    .then(r => utils.writeJson(res, r))
    .catch(e => utils.writeJson(res, { message: e.message }, e.status || 500));
};

module.exports.albumsAlbumIdTracksTrackIdDELETE = function (req, res, next, albumId, trackId) {
  Albums.albumsAlbumIdTracksTrackIdDELETE(albumId, trackId)
    .then(() => res.status(204).end())
    .catch(e => utils.writeJson(res, { message: e.message }, e.status || 500));
};

module.exports.albumsGET = function (req, res, next, page, limit, include, artistId, labelId, genre, tag, releaseState, q) {
...
module.exports.labelsLabelIdAlbumsGET = function (req, res, next, labelId, page, limit) {
